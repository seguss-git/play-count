...
Sideline app for tracking how many plays each kid gets in a youth football game, so nobody falls short of the league minimum.
...
- Data is per device. Use **Backup** on the Games tab to move it to another phone.
